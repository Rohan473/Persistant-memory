...
Institutional-grade quant research API.
"""
...
app = FastAPI(title="WQ Brain Memory API", version="0.3.0")
...
from .institutional_api import setup_institutional_routes
setup_institutional_routes(app)
